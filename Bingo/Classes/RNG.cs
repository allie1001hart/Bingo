 ...
 * Alexandra Hart 
 * 2/7/2018
 * RNG Class: (Most Provided by Frank Friedman)
 * Creates random numbers used in the game of BINGO
 */
...
namespace Bingo.Classes
{
...

    {
        ...
        //gets the random numbers for the bingo board
        ...
        public int getNextUniqueRandomValue(int minVal, int maxVal)
        {
            ...
            while (isUnique == false)
            {
                ...
                if (!Global.selectedNumbersListObj.isNumberUsed(rn))
                {
                    isUnique = true;
                    Global.selectedNumbersListObj.setUsedNumber(rn);
                } // end if
            } // end while                
            return rn;
